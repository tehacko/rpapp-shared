...
const ANALYTICS_LABEL_OVERRIDES: Record<AnalyticsEventName, LocalizedLabel> = {
  ...
  retail_ticket_created: { en: 'Collect-later ticket created', cs: 'Lístek pro vyzvednutí později vytvořen' },
  retail_pickup_scheduled: { en: 'Pickup slot scheduled', cs: 'Termín vyzvednutí naplánován' },
  retail_pickup_slot_missed: { en: 'Pickup slot missed', cs: 'Termín vyzvednutí zmeškán' },
  ...
  self_service_sla_notice_shown: { en: 'Pay-on-spot SLA notice shown', cs: 'Upozornění na dobu vyzvednutí u platby na místě' },
  ...
  kiosk_cash_complete: { en: 'Sales point cash checkout complete', cs: 'Hotovostní pokladna na platebním místě dokončena' },
  ...
  tenant_switched: { en: 'Tenant switched', cs: 'Organizace přepnuta' },
  ...
  kiosk_wakeup: { en: 'Sales point woken up', cs: 'Platební místo probuzeno' },
  kiosk_timeout: { en: 'Sales point timed out', cs: 'Platební místo — vypršení nečinnosti' },
  ...
  promo_preview_evaluated: { en: 'Promo preview evaluated', cs: 'Náhled akce vyhodnocen' },
  promo_reward_activated: { en: 'Promo reward activated', cs: 'Propagační odměna aktivována' },
  promo_reward_redeemed: { en: 'Promo reward redeemed', cs: 'Propagační odměna uplatněna' },
  promo_reward_rolled_back: { en: 'Promo reward rolled back', cs: 'Propagační odměna vrácena' },
  promo_progress_threshold_reached: {
    en: 'Promo progress threshold reached',
    cs: 'Dosažen práh postupu v akci',
  },
  promo_stacking_rejected: { en: 'Promo stacking rejected', cs: 'Kombinace akcí odmítnuta' },
  promo_budget_soft_stop: { en: 'Promo budget soft stop', cs: 'Měkký limit rozpočtu akce' },
  promo_budget_exhausted: { en: 'Promo budget exhausted', cs: 'Rozpočet akce vyčerpán' },
  ...
  pwa_install_accepted: { en: 'PWA install accepted', cs: 'Instalace aplikace přijata' },
  pwa_install_dismissed: { en: 'PWA install dismissed', cs: 'Instalace aplikace odmítnuta' },
  pwa_update_shown: { en: 'PWA update shown', cs: 'Aktualizace aplikace zobrazena' },
  pwa_update_deferred: { en: 'PWA update deferred', cs: 'Aktualizace aplikace odložena' },
  pwa_update_applied: { en: 'PWA update applied', cs: 'Aktualizace aplikace použita' },
};
