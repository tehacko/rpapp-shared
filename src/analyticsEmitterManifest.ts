...
export const ANALYTICS_EMITTER_MANIFEST: readonly AnalyticsEmitterManifestCell[] = [
  ...
  { eventName: 'catalog_interaction', surface: 'customer', layer: 'FE', required: true, reference: 'useShopScreenEffects' },
  { eventName: 'catalog_interaction', surface: 'kiosk', layer: 'FE', required: true, reference: 'useKioskOrchestrationRetail' },
  ...
  { eventName: ANALYTICS_V2_EXTENSION_EVENTS.MENU_OPENED, surface: 'customer', layer: 'FE', required: true, reference: 'useShopScreenEffects' },
  {
  ...
  { eventName: ANALYTICS_V2_EXTENSION_EVENTS.PRODUCT_SELECTED, surface: 'customer', layer: 'FE', required: true, reference: 'shopScreenHandlers' },
  { eventName: ANALYTICS_V2_EXTENSION_EVENTS.PRODUCT_SELECTED, surface: 'kiosk', layer: 'FE', required: true, reference: 'useKioskOrchestrationRetail' },
